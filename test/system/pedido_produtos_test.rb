...
class PedidoProdutosTest < ApplicationSystemTestCase
  ...
  test "creating a Pedido produto" do
    ...
    fill_in "Unidade", with: @pedido_produto.unidade
    fill_in "Valor total item", with: @pedido_produto.valor_total_item
    fill_in "Valor unitario", with: @pedido_produto.valor_unitario
