...
class PedidoProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido_produto" do
    assert_difference('PedidoProduto.count') do
      post pedido_produtos_url, params: { pedido_produto: { pedido_id: @pedido_produto.pedido_id, produto_id: @pedido_produto.produto_id, quantidade: @pedido_produto.quantidade, unidade: @pedido_produto.unidade, valor_total_item: @pedido_produto.valor_total_item, valor_unitario: @pedido_produto.valor_unitario } }
    end
  ...
  test "should update pedido_produto" do
    patch pedido_produto_url(@pedido_produto), params: { pedido_produto: { pedido_id: @pedido_produto.pedido_id, produto_id: @pedido_produto.produto_id, quantidade: @pedido_produto.quantidade, unidade: @pedido_produto.unidade, valor_total_item: @pedido_produto.valor_total_item, valor_unitario: @pedido_produto.valor_unitario } }
